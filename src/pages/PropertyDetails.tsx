    ...
    <div className="min-h-screen bg-black text-white selection:bg-[#FAFAFA] selection:text-black relative">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-6 h-20 flex justify-between items-center">
          <Link to="/" className="text-xl font-bold tracking-tight hover:text-[#FAFAFA] transition-colors" style={{ fontFamily: 'Poppins, sans-serif' }}>
            TOBILLION HOMES
          </Link>
          <Link to="/" className="text-sm font-bold tracking-[0.2em] hover:text-[#FAFAFA] transition-colors" style={{ fontFamily: 'JetBrains Mono, monospace' }}>
            BACK TO LISTINGS
          </Link>
        </div>
      </nav>
      ...
      <main className="pt-32 pb-20 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.5fr_1fr] gap-20">
          ...
          <div className="space-y-12">
            ...
            <div className="bg-neutral-900 border border-white/10 p-10 shadow-[8px_8px_0px_0px_#FAFAFA]">
      ...
      <div className="fixed bottom-0 inset-x-0 z-50 p-4 md:hidden">
        <a 
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center justify-center w-full py-5 bg-[#FAFAFA] text-black font-bold tracking-[0.2em] shadow-[4px_4px_0px_0px_#F97316] hover:shadow-[4px_4px_0px_0px_white] transition-all active:translate-x-0.5 active:translate-y-0.5 active:shadow-none"
        >
          BOOK A HOUSE TOUR
        </a>
      </div>
