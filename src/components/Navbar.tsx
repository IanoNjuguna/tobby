      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6 sm:px-8 py-5">
        ...
        <div className="flex gap-4 sm:gap-12 items-center">
          ...
          <div className="hidden lg:flex items-center gap-6 border-l border-white/10 pl-12 ml-4">
            ...
            <a href="https://instagram.com/tobillionhomes" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://tiktok.com/@tobillionhomes" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://linkedin.com/company/tobillionhomes" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
